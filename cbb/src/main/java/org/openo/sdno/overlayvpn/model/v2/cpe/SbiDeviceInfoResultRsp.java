...
@XmlType(name = "SbiDeviceInfoResultRsp", propOrder = {"data", "successed", "fail"})

@ApiModel(description = "String result model")
public class SbiDeviceInfoResultRsp extends ResultResponse {
    ...
    private List<List<SbiDeviceInfo>> successed = new ArrayList<List<SbiDeviceInfo>>();

    @XmlElement(name = "fail")
    @ApiModelProperty(example = "null", value = "the failed list.")
    private List<SbiDeviceInfoFailData> fail = new ArrayList<SbiDeviceInfoFailData>();
     ...
     * @return successed
     **/
    public List<List<SbiDeviceInfo>> getSuccessed() {
        return successed;
    }

    public void setSuccessed(List<List<SbiDeviceInfo>> successed) {
     ...
     * @return fail
     **/
    public List<SbiDeviceInfoFailData> getFail() {
        return fail;
    }

    public void setFail(List<SbiDeviceInfoFailData> fail) {
        this.fail = fail;
    }
    ...
    public String toString() {
        ...
        sb.append("class SbiDeviceInfoResultRsp {\n");

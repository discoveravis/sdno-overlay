...
@XmlType(name = "FailDataNbiCloudCpeModel", propOrder = {"errcode", "errmsg", "data"})

@XmlRootElement(name = "FailDataNbiCloudCpeModel")
@ApiModel(description = "Fail data model")
public class FailDataNbiCloudCpeModel {
    ...
    public String toString() {
        ...
        sb.append("class FailDataNbiCloudCpeModel {\n");

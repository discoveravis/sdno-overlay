...
@XmlType(name = "StringResultRsp", propOrder = {"data", "successed", "fail"})

@ApiModel(description = "String result model")
public class StringResultRsp extends ResultResponse {

    @XmlElement(name = "data")
    @ApiModelProperty(example = "null", value = "data body")
    private String data = null;

    @XmlElement(name = "successed")
    @ApiModelProperty(example = "null", value = "the successed list.")
    private List<String> successed = new ArrayList<String>();

    @XmlElement(name = "fail")
    @ApiModelProperty(example = "null", value = "the failed list.")
    private List<StringFailData> fail = new ArrayList<StringFailData>();
     ...
     * @return fail
     **/
    public List<StringFailData> getFail() {
        return fail;
    }

    public void setFail(List<StringFailData> fail) {
        this.fail = fail;
    }
    ...
    public String toString() {
        ...
        sb.append("class StringResultRsp {\n");

...
@XmlType(name = "FailDataNbiVlanModel", propOrder = {"errcode", "errmsg", "data"})

@XmlRootElement(name = "FailDataNbiVlanModel")
@ApiModel(description = "Fail data model")
public class FailDataNbiVlanModel {
    ...
    public String toString() {
        ...
        sb.append("class FailDataNbiVlanModel {\n");

...
@XmlType(name = "FailDataNbiSiteModel", propOrder = {"errcode", "errmsg", "data"})

@XmlRootElement(name = "FailDataNbiSiteModel")
@ApiModel(description = "Fail data model")
public class FailDataNbiSiteModel {
    ...
    public String toString() {
        ...
        sb.append("class FailDataNbiSiteModel {\n");

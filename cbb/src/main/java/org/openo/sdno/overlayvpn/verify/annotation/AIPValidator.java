...
/**
 * Annotation Validator Class of IpAddress.<br>
 * <p>
 * </p>
 * 
 * @author
 ...
 */
public class AIPValidator implements ConstraintValidator<AIp, String> {
     ...
     */
    @Override
    public void initialize(AIp constraintAnnotation) {
    ...
    public boolean isValid(String value, ConstraintValidatorContext context) {
        if(StringUtils.hasLength(value)) {
            Pattern pattern = Pattern.compile(ValidationConsts.IP_REGEX);

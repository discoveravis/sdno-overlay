 ...
 */
public abstract class ModelBase extends AbstUuidModel {
    ...
    public void copyBasicData(ModelBase data) {
        ...
        this.modifyMask = data.getModifyMask();
    }
    ...
    public void setModifyMask(String modifyMask) {

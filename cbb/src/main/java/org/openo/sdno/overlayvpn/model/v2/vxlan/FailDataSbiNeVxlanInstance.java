...
@XmlType(name = "FailDataSbiNeVxlanInstance", propOrder = {"errcode", "errmsg", "data"})

@XmlRootElement(name = "FailDataSbiNeVxlanInstance")
@ApiModel(description = "Fail data model")
public class FailDataSbiNeVxlanInstance {
    ...
    public String toString() {
        ...
        sb.append("class FailDataSbiNeVxlanInstance {\n");

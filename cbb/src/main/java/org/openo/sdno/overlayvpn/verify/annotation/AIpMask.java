...
/**
 * Annotation Validator Interface of IpMask.<br/>
 * <p>
 * </p>
 * 
 * @author
...
@Documented
@Constraint(validatedBy = AIpMaskValidator.class)
public @interface AIpMask {
     ...
     * @since SDNO 0.5
     */
    String message() default "ip/mask is invalid";

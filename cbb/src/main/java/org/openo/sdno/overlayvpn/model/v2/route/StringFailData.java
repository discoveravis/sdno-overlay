...
@XmlType(name = "StringFailData", propOrder = {"errorCode", "message", "data"})

@XmlRootElement(name = "StringFailData")
@ApiModel(description = "fail data model")
public class StringFailData {
    ...
    public String toString() {
        ...
        sb.append("class StringFailData {\n");

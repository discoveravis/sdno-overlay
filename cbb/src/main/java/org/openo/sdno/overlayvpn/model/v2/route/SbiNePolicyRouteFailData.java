...
@XmlType(name = "SbiNePolicyRouteFailData", propOrder = {"errorCode", "message", "data"})

@XmlRootElement(name = "SbiNePolicyRouteFailData")
@ApiModel(description = "fail data model")
public class SbiNePolicyRouteFailData {
    ...
    public String toString() {
        ...
        sb.append("class SbiNePolicyRouteFailData {\n");

...
@XmlType(name = "SbiInterfaceIpConfigFailData", propOrder = {"errorCode", "message", "data"})

@XmlRootElement(name = "SbiInterfaceIpConfigFailData")
@ApiModel(description = "fail data model")
public class SbiInterfaceIpConfigFailData {
    ...
    public String toString() {
        ...
        sb.append("class SbiInterfaceIpConfigFailData {\n");

...
public class VpnRouteTest extends TestManager {

    private static final String QUERY_ROUTE_URL = "/openoapi/sdnooverlay/v1/vpn-routes";
    ...
    @Test
    public void testQueryRouteSuccess() throws ServiceException {
        ...
        httpRequest.setUri(QUERY_ROUTE_URL);

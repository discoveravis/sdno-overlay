...
public class NqaSbiService extends AbstractSbiService<NetNqa> implements SbiService<NetNqa> {
    ...
    public void create(List<NetNqa> connectionList) throws ServiceException {
        ...
        doCreate(SBI_URL, NetNqa.class, connectionList);
    }

    @Override
    public void delete(String uuid) throws ServiceException {
        doDelete(SBI_URL, uuid, NetNqa.class);
        dao.delete(uuid, NetNqa.class);

    }

    @Override
    public void update(List<NetNqa> mos) throws ServiceException {
        doUpdate(SBI_URL, NetNqa.class, mos);
        dao.update(mos);
    }

    @Override
    public void deploy(List<String> uuidList) throws ServiceException {
        doDeploy(SBI_URL, NetNqa.class, uuidList);
    }

    @Override
    public void undeploy(List<String> uuidList) throws ServiceException {
        doUndeploy(SBI_URL, NetNqa.class, uuidList);
    }

    @Override
    public List<NetNqa> queryRemote(Set<String> uuids) throws ServiceException {
        return doQuery(SBI_URL, NetNqa.class, uuids);
    }
